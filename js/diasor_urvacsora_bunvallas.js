var Diasor_Urvacsora_Bunvallas =
{
    ...
    {   
        var t = " <tr id='dia_keszitese_sor_"+gomb_id+"' style='display:" + (rejtett ? "none" : "") + ";'>\n"
              ...
              + "  <td width='230'>Bűnvallás és Feloldozás</td>\n"
              + "  <td><button onclick=\"Diasor_Urvacsora_Bunvallas.uj_diasor('" + gomb_id + "', diasor_bovitese);\">&rarr;</button></td>\n"
              + " </tr>\n"
              + " <tr>\n"
              ;
        return(t);
